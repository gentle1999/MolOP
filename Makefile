...
help:
	...
	@echo "  make release     🚀 Print manual GitHub Release instructions"
	@echo ""
...
release:
	...
	@echo "---------------------------------------------------"
	@echo "Releases are created manually on GitHub:"
	@echo "1. Merge and commit all release changes on main."
	@echo "2. Open the GitHub release page:"
	@echo "   🔗 GitHub: $(REPOSITORY_URL)/releases/new"
	@echo "3. Draft a release, create a v* tag (e.g., v0.1.0) from main, and publish it."
	@echo "4. The tag triggers CI and the documentation deployment workflow."
	@echo "5. After all quality, build, documentation, and test gates pass, CI uploads distributions to the existing GitHub Release and publishes to PyPI."
	@echo "6. The docs workflow publishes the versioned documentation and latest alias."
	@echo "Track both workflow runs before announcing the release."
	@echo "---------------------------------------------------"
