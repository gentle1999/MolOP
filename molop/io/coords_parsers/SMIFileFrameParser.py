...
if TYPE_CHECKING:
    ...
    class _SMIFileFrameParserProtocol(object): ...
...
class SMIFileFrameParserMemory(
    SMIFileFrameParserMixin, BaseFrameParser[SMIFileFrameMemory]
):
    _file_frame_class_ = SMIFileFrameMemory

class SMIFileFrameParserDisk(
    SMIFileFrameParserMixin, BaseFrameParser[SMIFileFrameDisk]
):
