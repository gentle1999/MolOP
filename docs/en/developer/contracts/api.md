...
| Compose from the shell | [CLI command reference](../../reference/cli.md) | A terminal operation result |
...
See [transform behavior](../../reference/behavior/transforms.md) for writer domains, frame
...
- See the [CLI command reference](../../reference/cli.md) for parsing, filtering, summary,
  and conversion chains.
- See [Source evidence and serialization](../../reference/behavior/serialization.md) for exporting file metadata and frame
...
- [Transform behavior](../../reference/behavior/transforms.md)
- [Source evidence and serialization](../../reference/behavior/serialization.md)
- [Format support](../../reference/format_support.md)
- [Parser contract](parser.md)
