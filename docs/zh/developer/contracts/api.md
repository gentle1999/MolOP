...
| 使用命令行 | [CLI 命令参考](../../reference/cli.md) | 末端操作结果 |
...
writer domain、frame 组合和格式专用行为见[转换行为](../../reference/behavior/transforms.md)。
...
- [CLI 命令参考](../../reference/cli.md)说明解析、筛选、汇总和转换的命令链。
- [Source evidence 与序列化](../../reference/behavior/serialization.md)说明如何把文件级 metadata 与 frame 记录导出给
  数据库或审计系统。
...
- [转换行为](../../reference/behavior/transforms.md)
- [Source evidence 与序列化](../../reference/behavior/serialization.md)
- [格式支持](../../reference/format_support.md)
- [完整 Parser 契约](parser.md)
